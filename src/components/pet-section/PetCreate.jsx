...
const PetCreate = (props) => {
  ...
  //use usf
  const [title, setTitle] = React.useState("Awesome Pet");
  const [description, setDescription] = React.useState("No accidents today!");
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // ! make sure you add authorization to the headers if you need a token for that route. This one, you do. Login, you dont.
      ...
      // Send Request
      const response = await fetch(API_PET_CREATE, requestOption);
      ...
      <div className="d-flex neutral-background rounded p-5 flex-column">
        ...
        <Form className="w-100">
          ...
          <FormGroup>
            ...
            {/* Add a value and assign it (read only), onChange function to update the state */}
            <Input
              value={title}
